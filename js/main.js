...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const observer = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      if (entry.isIntersecting) {
        ...
        const targetPercentage = parseInt(skillBar.getAttribute('data-value'));
        
        animateSkill(skillBar, percentageElement, targetPercentage);
  ...
  function animateSkill(skillBar, percentageElement, targetPercentage) {
    let startTime;
    ...
    function animate(currentTime) {
      ...
      const currentValue = progress * targetPercentage;

      // Update skill bar
      skillBar.style.width = `${currentValue}%`;
  ...
  $(window).on("beforeunload", function () {
    // Menutup navbar jika terbuka
    var navbarTrigger = $(".burger-icon");
    var container = $(".mobile-header-active");
    if (container.hasClass("sidebar-visible")) {
        container.removeClass("sidebar-visible");
  ...
  $(window).on("scroll", function () {
    ...
    // Cek apakah navbar dalam keadaan terbuka
    if (container.hasClass("sidebar-visible")) {
        // Tutup navbar
        container.removeClass("sidebar-visible");
        navbarTrigger.removeClass("burger-close");
  ...
  $(document).on("click", function (e) {
    ...
    // Cek apakah klik terjadi di luar navbar dan tombol burger
    if (!$(e.target).closest(".mobile-header-active").length && 
